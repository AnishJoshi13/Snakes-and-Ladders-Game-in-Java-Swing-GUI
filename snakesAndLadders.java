...
class startScreen extends JFrame implements ActionListener {
    ...
    Image icon = Toolkit.getDefaultToolkit().getImage("C:/Users/Anish Joshi/Downloads/snakesAndLaddersIcon.png");   // Importing image for window Icon
    Font F = new Font("Arial", Font.BOLD, 15);
    startScreen() {
        snakeIm = new JLabel(new ImageIcon("C:/Users/Anish Joshi/Downloads/snake (Custom).jpg"));
        snakeIm.setBounds(0,20,250,130);
        ladderIm = new JLabel(new ImageIcon("C:/Users/Anish Joshi/Downloads/ladder (Custom).jpg"));
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == start) {
            dispose();
            new players();  // Opens players window to get player details.
        }
...
class playBox extends JFrame implements ActionListener {
    ...
    ImageIcon pgp = new ImageIcon("C:/Users/Anish Joshi/Downloads/pgp (Custom).png");   // Importing images for each game piece by colour.
    ImageIcon ggp = new ImageIcon("C:/Users/Anish Joshi/Downloads/ggp (Custom).png");
    ImageIcon bgp = new ImageIcon("C:/Users/Anish Joshi/Downloads/bgp (Custom).png");
    ImageIcon ygp = new ImageIcon("C:/Users/Anish Joshi/Downloads/ygp (Custom).png");
    ...
    final Map<Integer,Integer> snakes = new HashMap<Integer,Integer>() {
        {
            put(17,1);      // head position of the snake is the key and its tail position is the value
            put(62,19);
            put(87,24);
            put(54,34);
            put(64,60);
    ...
    playBox() {
        ...
        rand = new Random();
        diceIm = new ImageIcon("C:/Users/Anish Joshi/Downloads/dice.png");  // Importing image of dice for JButton dice icon.
...
class board extends JFrame {
    ...
    Image icon = Toolkit.getDefaultToolkit().getImage("C:/Users/Anish Joshi/Downloads/snakesAndLaddersIcon.png");
    board() {
        JLabel bg = new JLabel(new ImageIcon("C:/Users/Anish Joshi/Downloads/snakesAndLadders.jpg"));   // Importing board image.
        add(bg);
        for (int i : sq) {
